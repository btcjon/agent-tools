...
For a first integration, read [references/agent-start-here.md](references/agent-start-here.md). Read [references/harness-integration.md](references/harness-integration.md) when adapting Hermes or another harness. Read [references/operations.md](references/operations.md) for installation, profiles, migration, observability, and rollback. Read [references/notion-pilot.md](references/notion-pilot.md) only for the read-only Notion snapshot pilot. Read [references/skillranker-ideas.md](references/skillranker-ideas.md) only when planning future product improvements.
