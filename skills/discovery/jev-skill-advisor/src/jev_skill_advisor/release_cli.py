...
from .release import ReleaseStore, build_shadow_release
...
def main(argv=None):
    ...
    build = commands.add_parser("build-shadow")
    ...
    if args.command == "build-shadow":
        ...
        release_id, manifest = build_shadow_release(root=args.root, snapshot_id=args.snapshot_id,
