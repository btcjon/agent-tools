# Source revision freeze (v0.1.0)

Packaged from global contract **Version 3.33** and matching Herdr mode / claims helpers.

| Source role | SHA-256 (at freeze) |
|---|---|
| Global contract (SOUL) Herdr paragraph | `080aba27efb5594e5b8d3333e0778700f9f797b7e550798e9dfc79edd44b78cd` |
| Herdr `mode.md` (canonical routing policy) | `191f6fba1543e9ed48f883f434ff2ff514cf675f8ec8aad3458de6fbfc2817cc` |
| `claims.py` helper | `96e759fea7f9eb6a4a72c9a7e83c2c375f20b0fb78f1bb7b32471b52b1eda00f` |
| Stock `herdr` skill (CLI authority; not copied) | `f396d13c095b13063865fd520cd879e9f6f773b887e8b95b92feeed456856740` |
